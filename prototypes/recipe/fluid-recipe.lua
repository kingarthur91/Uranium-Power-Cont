...
{
	{
		...
		icon = "__UraniumPowerRemastered__/graphics/icons/coal-ash-recipe.png",
		icon_size = 32,
	...
	--[[{
		...
		icon = "__UraniumPowerRemastered__/graphics/entity/2x2-heat-exchanger/heatexchangerecipeicon.png",
		icon_size = 32,
		subgroup = "uranium-heatexchangerecipes",
		order = "ab"
	},
