...
{
	{
		...
		icon = "__UraniumPowerRemastered__/graphics/icons/pressurized-water.png",
		icon_size = 32,
	...
	},
	{
		...
		max_temperature = 100,
		icon = "__UraniumPowerRemastered__/graphics/icons/fluorine-gas.png",
		icon_size = 32,
		pressure_to_speed_ratio = 0.4,
		flow_to_energy_ratio = 0.59,
	...
	},
	{
		...
		max_temperature = 100,
		icon = "__UraniumPowerRemastered__/graphics/icons/uraninite-slurry.png",
		icon_size = 32,
	...
	},
	{
		...
		max_temperature = 350,
		icon = "__UraniumPowerRemastered__/graphics/entity/steam/superheated-steam.png",
		icon_size = 32,
	...
	},
	{
		...
		flow_color = {r=1, g=1, b=1},
		max_temperature = 300,
		icon = "__UraniumPowerRemastered__/graphics/entity/steam/low-pressure-steam.png",
		icon_size = 32,
